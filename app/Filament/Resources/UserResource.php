...
class UserResource extends Resource
{
        ...
        return $form
            ->schema([
                Forms\Components\Select::make('domaine_id')
                    ->relationship('domaine', 'nom_du_domaine')
                    ->required(),
                ...
                Forms\Components\TextInput::make('email')
                    ...
                    ->options([
                        'Prof_Admin' => 'Prof_Admin',
                        'Prof' => 'Prof',
                    ])
                    ->disabled()
                    ->default(fn ($get) => $get('typeUser'))
                    ->required(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('domaine.nom_du_domaine')
                    ->numeric()
                    ->sortable(),
                ...
                Tables\Columns\TextColumn::make('email')
                    ->searchable(),
                Tables\Columns\TextColumn::make('typeUser')
                    ->searchable(),
